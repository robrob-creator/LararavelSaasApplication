...
<div class="container mx-auto px-6 py-8">
            ...
            <div class="w-full px-6 sm:w-1/2 xl:w-1/3">
                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 float-left ..." fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <h4 class=" text-3xl font-semibold text-gray-700 ">{{App\Models\User::count()}}</h4>
                        </div>
                        <div class="text-gray-500">Number of Users</div>
                    </div>
                </div>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                        ...
                        <h4 class="text-3xl font-semibold text-gray-700">{{App\Models\Team::count()}}</h4>
                    </div>
                        <div class="text-gray-500">Number of Teams</div>
                    </div>
                </div>
            </div>
...
<h1 class="text-gray-700 text-3xl font-medium">Team Members List</h1>
